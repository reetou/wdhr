...
export default class AppStore {
  ...
  @observable rules = [
    'Выключи телегу/ютуб/игори/кино/говно и вкатывайся. Сделай так, чтобы во время вката не мешали мамка/бабка/тян/собака/сосед.',
    ...
    'Пиши свой проект. Никаких тудулистов.',
    ...
    'Не употребляй вещества и пласебо - по началу может быть эффект, но откат не заставит себя ждать, в итоге станешь овощем.',
